...
load('Workspaces/site_4_01-26-2014.mat')
timeshift = 190;
timestamp = timestamp - timeshift; % Shift to main data set

extension = '01-26-2014';

sites_all = [4:7 10:15 17 18 20 26 28 29 30 32 33 36:43 46 47 49 51 52 54 56:58 60];
sites_colored = [4:7 10:15];
