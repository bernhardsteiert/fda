...
load('Workspaces/site_1_01-27-2014.mat')
timeshift = 350;
timestamp = timestamp - timeshift; % Shift to main data set

extension = '01-27-2014';

sites_all = [1:4 8:12 14 15 17:22 24 27 28 30:47 49:58 60];
sites_colored = [1:4 21 22 24 27 28];
...
for isite = highdoses
    ...
    titstr = sprintf('%s%s%g%s%g',titstr,s.drug1_name,s.drug1_dose,s.drug2_name,s.drug2_dose);
    legstr{end+1} = titstr;
